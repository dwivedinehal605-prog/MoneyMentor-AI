...
class MonthlyPredictionResponse(BaseModel):
    ...
    savings_status: str = Field(
        ...,
        examples=["Positive Savings"],
        description="Current projected savings status.",
    )
    ...
    forecast: str = Field(
        ...,
        examples=[
            "Excellent! You are projected to stay within your monthly budget with approximately ₹6000.00 remaining."
        ],
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                ...
                "forecast": (
                    "Excellent! You are projected to stay within your "
                    "monthly budget with approximately ₹6000.00 remaining."
                ),
            }
        }
    }